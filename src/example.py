# Date Entity Parser - Example Usage
...
# Original code to obtain the 'date_entities' list of date strings from the above text:
"""
import spacy
...
# String representation of date_entities extracted from text (used to illustrate dateentityparser functions, without needing to install SpaCy):
date_entities = ['the last weeks of 1956','6 July 1957','February 1958','the first week of March 1958','early January 1959','January 1960','May 1958','early July 1960','the middle of August 1960','mid-August 1960','17 August 1959','late Nov 1960','late-August 1960','the beginning of December 1960','around the end of February 1961','about four weeks','1961','about mid-1961','June 1962','the final days of June 1961','mid-late Oct 1961','About six months later','the tax year ending November 1961']

from dateentityparser.parser import parser
dtparser = parser()
# dates = [dtparser.parse(date.text) for date in date_entities] # If using date_entities SpaCy object
...
print("| %12s | %20s | %18s | %18s | %-40s |" % ("PY DATE", "FORMAT", "SUCCESSFUL PARSE", "DISPLAY DATE", "ORIGINAL TEXT"))
print("| %-12s | %-20s | %-18s | %-18s | %-40s |" % ("---", "---", "---", "---", "---"))
for date in dates:
    print("| %12s | %20s | %18s | %18s | %-40s |" % (date.formatted, date.format, date.success, date.display_date(), date.text))
